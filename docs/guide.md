...
Pipeline is an agent workflow engine. Everything it knows about your project lives in `.claude/pipeline.yml`. This file is generated by `/pipeline:init` and can be edited directly anytime.
